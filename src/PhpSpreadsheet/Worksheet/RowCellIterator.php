...
class RowCellIterator extends CellIterator
{
     ...
     */
    public function __construct(Worksheet $worksheet, private readonly int $rowIndex = 1, string $startColumn = 'A', ?string $endColumn = null, bool $iterateOnlyExistingCells = false)
    {
