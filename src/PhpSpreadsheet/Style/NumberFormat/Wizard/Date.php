...
class Date extends Date_Time_Wizard
{
    /**
     ...
     */
    public function __construct($separators = self::SEPARATOR_DASH, string|null ...$format_blocks)
    {
        $separators ??= self::SEPARATOR_DASH;
        $format_blocks = count($format_blocks) === 0 ? self::DATE_DEFAULT : $format_blocks;
