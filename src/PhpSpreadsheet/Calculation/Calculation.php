...
class Calculation extends CalculationLocale
{
     ...
     */
    private readonly CyclicReferenceStack $cyclicReferenceStack;
        ...
        while (true) {
            ...
            if ($opCharacter === '-' && !$expectingOperator) {                //    Is it a negation instead of a minus?
                ...
                if (preg_match('/^' . self::CALCULATION_REGEXP_FUNCTION . '$/miu', $val, $matches)) {
                    ...
                    $length = strlen($val);
                    $outputItem = $stack->getStackItem(Operands\StructuredReference::NAME, $structuredReference);
            ...
            if ($token instanceof Operands\StructuredReference) {
                ...
                try {
                    ...
                    if ($e->getCode() === Exception::CALCULATION_ENGINE_PUSH_TO_STACK) {
                        $stack->push('Error', ExcelError::REF());
                ...
                switch ($token) {
                    ...
                    case '∩':            //    Intersect
                        ...
                        if (count(Functions::flattenArray($cellIntersect)) === 0) {
                            ...
                            $stack->push('Error', ExcelError::null());
                        } else {
    ...
    private function validateBinaryOperand(mixed &$operand, Stack &$stack): bool
    {
        ...
        if (is_string($operand)) {
            ...
            if (!is_numeric($operand)) {
                ...
                //    If not a numeric, test to see if the value is an Excel error, and so can't be used in normal binary operations
                if (Engine\FormattedNumber::convertToNumberIfFormatted($operand) === false) {
